...
export function PersonaProjectSlot({
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative z-10 px-5 py-3 font-linux-biolinum text-base tracking-widest transition-colors [-webkit-text-stroke:0.5px_currentColor] [text-stroke:0.5px_currentColor] md:text-lg ${
          isActive
