...
const devOpsSkills = (): SkillNode[] => {
  return [
    ...
    },
    {
      ...
      position: { x: 2, y: 0 },
      neighbors: { downLeft: "ops-docker", downRight: "ops-nginx" },
    },
    {
      id: "ops-actions",
      name: "GitHub Actions",
      ...
      position: { x: 0, y: 1 },
      neighbors: { down: "ops-vercel", right: "ops-docker" },
    },
    {
      id: "ops-docker",
      name: "Docker",
      ...
      position: { x: 1, y: 1 },
      neighbors: { downRight: "ops-prometheus" },
    },
    {
      id: "ops-nginx",
      name: "Nginx",
    ...
    },
    {
      id: "ops-prometheus",
      name: "Prometheus",
      description: "Systems and service monitoring framework.",
      icon: "/images/skills/prometheus.svg",
      position: { x: 2, y: 2 },
      neighbors: { right: "ops-grafana", down: "ops-artillery" },
    },
    {
      id: "ops-grafana",
      name: "Grafana",
      description: "Operational dashboards and data visualization.",
      icon: "/images/skills/grafana.svg",
      position: { x: 3, y: 3 },
      neighbors: {},
    },
    {
      id: "ops-artillery",
      name: "Artillery",
      description: "Cloud-scale load testing framework.",
      icon: "/images/skills/artillery.svg",
      position: { x: 2, y: 3 },
      neighbors: {},
    },
  ];
