...
export const experienceData: ExperienceData[] = [
  {
    ...
    deliverables: [
      {
        tag: "UI ARCHITECTURE",
        title: "Declarative UI & Jetpack Compose",
        desc: "Coached students on reactive UI paradigms, composable state hoisting, and dynamic layout rendering in Kotlin.",
      },
      {
        tag: "KOTLIN CONCURRENCY",
        title: "Asynchronous Coroutines & Flows",
        desc: "Demonstrated Kotlin Coroutines, asynchronous data streams, and lifecycle-aware architecture components for responsive mobile apps.",
      },
      {
        tag: "CODE QUALITY",
        title: "Material Design & Architectural Audits",
        desc: "Guided lab implementations according to Material 3 design specifications and audited clean-code patterns.",
      },
    ],
  ...
  },
  {
    ...
    deliverables: [
      {
        tag: "THREAT MODELING",
        title: "Vulnerability Auditing & Pen-Testing",
        desc: "Guided student teams through penetration testing methodologies, OWASP Top 10 web vulnerabilities, and security auditing tools.",
      },
      {
        tag: "NETWORK DEFENSE",
        title: "Packet Analysis & Traffic Inspection",
        desc: "Supervised packet-level network inspection, TLS handshake diagnostics, and intrusion detection exercises using Wireshark.",
      },
      {
        tag: "CRYPTOGRAPHY",
        title: "Cryptographic Protocols & Key Systems",
        desc: "Instructed on asymmetric encryption schemes, public key infrastructure (PKI), digital signatures, and hashing integrity.",
      },
    ],
